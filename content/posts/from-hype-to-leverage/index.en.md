...
# Deconstructing the problem: why we\'re stuck {#deconstructing-the-debate-why-were-stuck}
...
shows \"stocks\" or \"state of the system\" influenced by an \"inflow\"
and \"outflow.\" A \"perceived state\" is derived from the stocks, and a
\"discrepancy\" is calculated by comparing the perceived state to a
\"goal.\" This discrepancy then influences either the inflow or outflow,
creating a feedback loop to adjust the system\'s state towards the
goal.](./figure-1.webp)
...
[here](doi:10.48550/arXiv.2205.01070).
...
*arXiv:2412.16641v4 \[cs.AI\]*.

Meadows, D. (1999). *Leverage Points: Places to Intervene in a System*.
The Sustainability Institute.

Nabavi, E., & Browne, C. (2022). Five Ps: Leverage Zones towards
Responsible AI. *Preprint, The Australian National University*.

Siebert, L. C., Lupetti, M. L., Aizenberg, E., et al. (2022). Meaningful
human control: actionable properties for AI system development.
*arXiv:2112.01298v2 \[cs.CY\]*.
